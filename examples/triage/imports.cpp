...
ImportsTreeView::ImportsTreeView(ImportsWidget* parent, TriageView* view, BinaryViewRef data) :
    QTreeView(parent)
{
	m_data = data;
	m_parent = parent;
	...
	connect(selectionModel(), &QItemSelectionModel::currentChanged, this,
	    &ImportsTreeView::importSelected);
...
ImportsWidget::ImportsWidget(QWidget* parent, TriageView* view, BinaryViewRef data) :
    QWidget(parent)
{
