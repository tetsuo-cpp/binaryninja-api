...
class BINARYNINJAUIAPI TagTypeListModel :
    ...
    public BinaryNinja::BinaryDataNotification
{
 ...
 public:
	...
	bool setModelData(const std::vector<TagTypeRef>& refs, QItemSelectionModel* selectionModel,
	    int sortColumn, Qt::SortOrder sortOrder, bool& selectionUpdated);
